    ...
    if (this.props.players.length > 0) {
      switch (this.state.step) {
        case 1:
          ...
          this.props.calculateFgAndFtImpacts(
            this.props.players,
            this.props.means
          );
        ...
        case 3:
          ...
          this.props.calculateStdDeviations(
            this.props.players,
            this.props.means
          );
        ...
        case 4:
          ...
          this.props.calculateZScores(
            this.props.players,
            this.props.means,
            this.props.stdDeviations
          );
  ...
  render() {
    return (
      <Jumbotron
        ...
        className="player-fetch-transition"
      >
        <h2 style={{ fontWeight: "bold" }}>Fetching Player/Team Data</h2>
